...
ids = pd.read_csv("input_data/MatchedSubjects.csv", sep = ";")["Heliusnr"].values
labels = pd.read_csv("input_data/MatchedSubjects.csv", sep = ";")["aTPOGroup"].values
